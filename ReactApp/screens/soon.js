...
class ComingSoon extends Component {
    ...
    render = () => {
        if(!this.props.profile.profile.userId) {
            return(
                <View style={[AppStyles.container], [AppStyles.paddingHorizontal], {margin: 30}}>
        ...
        <View style={[AppStyles.paddingVerticalSml]}></View>
         <Text style={{color: "darkgray", fontSize: 19, fontFamily: "ChalkboardSE-Light", textAlign: 'center'}}> Your Future, Your Move. </Text> 
        <View style={[AppStyles.paddingVerticalSml]}></View>
        ...
        <Button
                ...
                <Text style={{color: "lightgray", fontSize: 11, textAlign: 'center'}}> Legal </Text>  
                
                <Text style={{color: "lightgray", fontSize: 11,textAlign: 'center'}}> &copy; 2017 Matthew B. Weatherford</Text>   
